          ...
          <div class="main-cont__left">
            ...
            >
                  ...
                  <div class="search__field">
                      <div class="search-block">
                          <input 
                            ...
                            v-model="requestData.freeOffers.name"
                          >
                          <a 
                            href="#" 
                            class="remove-search-data text-muted" 
                            v-if="requestData.freeOffers.name"
                            @click.prevent="clearSearchForm('#free-offers','freeOffers')"
                  ...
                  <input 
                    ...
                    value="Find"
                    :class="{disabled: !requestData.freeOffers.name}" 
                    :disabled="!requestData.freeOffers.name"
                    @click.prevent="sendSearchForm('#free-offers','freeOffers')"
                  >
              </form>
              <div class="one-block-product" id="free-offers">
                      ...
                      <div class="filter__section d-flex align-items-center">
                          ...
                          <ul class="select-number-views">
                              <li 
                                ...
                                @click.prevent="getOffersNav(offerNav, '#free-offers','freeOffers')"
                              >
                                  <a 
                                    href="#" 
                ...
                <h3 
                    ...
                    class="m-4"
                >No Offers</h3>
                <Offer v-else :offers="freeOffers"></Offer>
                <div class="text-center">
                    <button 
                        ...
                        @click.prevent="paginateOffers('#free-offers','freeOffers')"
...
<script>
  import {offers} from 'mixins/offers'
    ...
    mounted(){
        // ПОЛУЧАЕМ freeOffers
        this.getOffersAndSetClicks('#free-offers','freeOffers')
    }
  }
</script>
