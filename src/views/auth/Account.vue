        ...
        <div class="wrapper wrapper_long">
            ...
            <div class="main-cont">
                <div class="main-cont__white main-cont__white_with-column clearfix">
                    <div class="box-member-status style1">
                        <h1 class="main-title">Basic Member Status</h1>
                        <router-link :to="{name: 'balance'}" class="button button_big button_balance">
                            Balance
                        </router-link>
                        <router-link :to="{name: 'withdraw'}" class="button button_big button_withdrawall">
                            Withdraw
                        </router-link>
                        <router-link :to="{name: 'profile'}" class="button button_big button_profile">
                            Profile
                        </router-link>
                        <router-link :to="{name: 'survey'}" class="button button_big button_profile">
